...
# Rough Terrain Walking 2D ==============================
register_env_with_variants(id='myoLegRoughTerrainWalk2D-v0',
        entry_point='myosuite.envs.myo.myobase.walk_0_22mus2D:ReachEnvV0',
        max_episode_steps=1000,
        kwargs={
            'model_path': curr_dir + leg_model,
            'normalize_act': True,
...
# Rough Terrain Walking 2D Imitation Learning ==============================
register_env_with_variants(id='myoLegRoughTerrainWalk2DImitationLearning-v0',
        entry_point='myosuite.envs.myo.myobase.walk_0_22mus2D_imitation_learning:ReachEnvV0',
        max_episode_steps=10000,#its not working
        kwargs={
            'model_path': curr_dir + leg_model,
            'normalize_act': True,
            'min_height':0.8,    # minimum center of mass height before reset
